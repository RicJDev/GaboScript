...
const INDENT_KEYWORDS = [
  'Algoritmo', 'Inicio', 'Si', 'Sino', 'En_Caso', 'Caso',
  'Funcion', 'Procedimiento', 'Mientras', 'Para', 'Repetir',
  'Registro', 'Hacer', 'Entonces',
];

const DEDENT_KEYWORDS = [
  'Fin', 'Fin_Si', 'Fin_Caso', 'Fin_Funcion', 'Fin_Procedimiento',
  'Fin_Mientras', 'Fin_Para', 'Fin_Repetir', 'Fin_Registro', 'Sino',
];

export class GaboScriptFormatter implements vscode.DocumentFormattingEditProvider {
